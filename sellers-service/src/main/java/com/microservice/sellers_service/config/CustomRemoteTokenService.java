...
// not only application/*json, which is the default behaviour
    ...
    public OAuth2Authentication loadAuthentication(String accessToken) throws AuthenticationException, InvalidTokenException {
        ...
        Map<String, Object> map = executeGet("https://localhost:8081/uaa/oauth/check_token?token=" + accessToken, headers);
    ...
    private Map<String, Object> executeGet(String path, HttpHeaders headers) {
        try {
            ...
            Map map = restTemplate.exchange(path, HttpMethod.POST, new HttpEntity<MultiValueMap<String, String>>(null, headers), new HashMap<String, Object>().getClass()).getBody();
